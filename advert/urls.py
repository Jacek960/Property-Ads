...
from .views import HomePageView, AdByCategoryView, AllAdsView, AdsByLocationView, DashbordView, AdsDetailsView, AdCreateView, AdvertUpdate,AdDeleteView, SearchView
